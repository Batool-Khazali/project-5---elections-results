...
namespace test_3.Controllers
{
    ...
    {
        private testing_election_resultsEntities db = new testing_election_resultsEntities();
        ...
        public ActionResult functionTest()
        {
            ...
            ViewBag.message = localVotersCount("اربد الاولى");
            ViewBag.message2 = localThreshold("اربد الاولى");
            ViewBag.message3 = localListsAboveThreshold("اربد الاولى").ToList();
            ViewBag.message4 = localWinningListsVotesSum("اربد الاولى");
            ViewBag.message5 = localListsSeats("اربد الاولى").ToList();
            ViewBag.message6 = localListsCanditates("اربد الاولى").ToList();
            ViewBag.message7 = localListsAndCanditates("اربد الاولى").ToList();
            ViewBag.message8 = localWomanSeat("اربد الاولى");
            ViewBag.message9 = localChristianSeat("اربد الاولى");
            ViewBag.message10 = partyListsAndCanditates();
            ViewBag.message11 = partyPercentage();
        ...
        public List<string> localListsCanditates(string d)
        {
            ...
            var localCanditates = db.localCanditates.ToList();
        ...
        public List<string> partyListsAboveThreshold()
        {
            ...
            foreach (var row in allPartyLists)
            {
                ...
                {
                    string addedList = $"{row.ID}, {row.listname}, {row.electionarea}, {row.votes_counter}";
        ...
        public List<string> partyListsCanditates()
        {
            ...
            foreach (var row in partyCan)
            {
                ...
                {
                    if (can.listname == listName)
                    {
                        string canditateNameAndId = $"{can.ID}, {can.name}, {can.listname}, {can.ordercandidate}";
